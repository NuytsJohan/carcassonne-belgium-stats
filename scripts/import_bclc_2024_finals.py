"""BCLC 2024 - All placement finals (1st/3rd/5th/7th/9th/11th/13th/15th)."""
...
MATCHES = [
    ("Final",       1, "Nico Wellemans",        98, "Niels Ongena",            87, "1"),
    ("3rd Place",   1, "Nicolas Victor",       139, "Jochen Keymeulen",       120, "1"),
    ("5th Place",   1, "Fabian Mouton",         94, "Bart Dejaegher",          80, "1"),
    ("7th Place",   1, "Lorenzo Van Herrewege",140, "Kenny Forrez",           136, "1"),
    ("9th Place",   1, "Maud Quaniers",         81, "Raf Mesotten",            96, "2"),
    ("11th Place",  1, "Jeroen Smolders",      105, "Kristof Kesteloot",       88, "1"),
    ("13th Place",  1, "Harlinde Dewulf",       88, "Christine Coulon",        89, "2"),
    ("15th Place",  1, "Wannes Vansina",        98, "Tania Vanderaerden",      69, "1"),
]
